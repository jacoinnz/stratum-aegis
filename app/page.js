...
const HOME_STYLE = `
  ...
  .hero-diagram .half{ position:absolute; inset:0; display:flex; flex-direction:column; padding:22px; }
  .hero-diagram .half.left{ clip-path:polygon(0 0,100% 0,0 100%); background:var(--system1); justify-content:flex-start; }
  .hero-diagram .half.right{ clip-path:polygon(100% 0,100% 100%,0 100%); background:var(--system2); justify-content:flex-end; }
...
const HOME_STYLE = `
  ...
  .hero-diagram .half.right{ clip-path:polygon(100% 0,100% 100%,0 100%); background:var(--system2); justify-content:flex-end; }
  .hero-diagram .lbl{ font-family:"IBM Plex Mono",monospace; font-size:12px; letter-spacing:0.08em; text-transform:uppercase; color:rgba(255,255,255,0.92); font-weight:600; }
  .hero-diagram .lbl small{ display:block; font-family:"Source Sans 3",sans-serif; text-transform:none; letter-spacing:0; font-weight:400; opacity:0.85; margin-top:3px; font-sexport const metadata = {
  title: "CU-BOM — The Decision Operating Model for Fast and Slow Thinking",
  description:
    "CU-BOM is a free operating model for business decisions: the Premortem, the DWA Protocol, the Structural Pause, and the Friction Dial, each with a safeguard that says when it's actually safe to use. Written in New Zealand.",
  alternates: { canonical: "https://stratumaegis.com/" },
